# [SOLVED] Git Fatal Pathspec Is In Submodule
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/git-fatal-pathspec-is-in-submodule)

---

### 🔍 Quick Technical Overview & Summary:
Try using 'git add -f' or 'git add --force' to force the addition of submodule files.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/git-fatal-pathspec-is-in-submodule)**
